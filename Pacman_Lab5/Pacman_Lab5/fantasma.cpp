...
{
    posx = x;//POSICION EN X DEL FANTASMA
    posy = y;//POSICION EN Y DEL FANTASMA
    setPos(posx,posy);//ESTABLESEMOS LA POSICION DEL FANTASMA
    timer = new QTimer();//CON ESTA VARIABLE ACTUALIZAREMOS CADA DETERMINADO TIEMPO LA PANTALLA PARA CUANDO PACMAN SE COMA UNA PASTILLA
    fila = 0;
    columna =120;
    pixmap =new QPixmap(":/imagenes/Pacmandeff.png");//CARGAMOS LA IMAGEN DEL MAPA PACMAN
